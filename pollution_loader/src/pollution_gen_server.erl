...
%% API
-export([start_link/0, stop/0, getAirQualityIndex/2, getDailyMean/2, getStationMean/2, getOneValue/3, findStation/1, removeValue/3, addValue/4, addStation/2, crash/0]).
